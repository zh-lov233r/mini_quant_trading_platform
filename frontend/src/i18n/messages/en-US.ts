...
export const enUSMessages: typeof zhCNMessages = {
  ...
  marketViewer: {
    trigger: "Market",
    title: "Stock Candles",
    subtitle: "Enter a ticker and date range to view the daily OHLC candlestick chart.",
    symbol: "Ticker",
    symbolPlaceholder: "For example AAPL",
    startDate: "Start Date",
    endDate: "End Date",
    load: "Load Chart",
    loading: "Loading...",
    closeWindow: "Close window",
    initialHint: "The widget starts with roughly the last 3 months of daily bars, and you can change the ticker or range anytime.",
    empty: "No daily bars are available in this range.",
    emptyHint: "Try a longer window or switch to another ticker.",
    invalidRange: "Start date cannot be after end date.",
    loadFailed: "Failed to load the candlestick chart.",
    latestClose: "Latest Close",
    intervalReturn: "Window Return",
    priceRange: "High / Low",
    barCount: "Bars",
